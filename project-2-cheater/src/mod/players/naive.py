...
class NaivePlayer(Player):
  ...
  def on_accusation(self, is_player, were_cards_drawn, revealed, taken_count):
    if is_player:
      if were_cards_drawn: self.on_wrong_accusation(revealed, taken_count)
      else: self.on_right_accusation(revealed, taken_count)
    else:
      if were_cards_drawn: self.on_caught(taken_count)
      else: self.on_honest(taken_count)

  def on_wrong_accusation(self, revealed, taken_count): pass
